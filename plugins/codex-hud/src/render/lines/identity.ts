...
const DEBUG =
  process.env.DEBUG?.includes("codex-hud") || process.env.DEBUG === "*";
...
export function renderIdentityLine(
  ...
  if (DEBUG && autocompactMode === "disabled") {
    console.error(
      `[codex-hud:context] autocompactBuffer=disabled, showing raw ${rawPercent}% (buffered would be ${bufferedPercent}%)`,
    );
  }
